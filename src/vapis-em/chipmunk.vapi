...
namespace cp {
	...
	public class Body {
		...
		[CCode (cname = "cpBodyGetPosition")]
		public cp.Vect get_position ();
		...
		[CCode (cname = "cpBodySetPosition")]
		public void set_position (cp.Vect pos);
	...
	public class Shape {
		...
		[CCode (cname = "cpShapeGetBody")]
		public cp.Body get_body ();
		...
		[CCode (cname = "cpShapeSetCollisionType")]
		public void set_collision_type (int type);
		[CCode (cname = "cpShapeSetElasticity")]
		public void set_elasticity (double elasticity);
		[CCode (cname = "cpShapeSetFriction")]
		public void set_friction (double friction);
		[CCode (cname = "cpShapeSetUserData")]
	...
	public class Space {
		...
		public void set_default_collision_handler (
			...
			[CCode (delegate_target_cname = "cpCollisionSeparateFunc")] cp.CollisionSeparateFunc? separate,
			void* data);
		[CCode (cname = "cpSpaceSetGravity")]
		public void set_gravity(cp.Vect gravity);
