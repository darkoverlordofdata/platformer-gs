...
void systems_physics (Systems* self, Entity** player, gint tick) {
	...
	ground = _tmp17_;
	_tmp18_ = sdx_direction;
	_tmp18__length1 = sdx_direction_length1;
	...
	_tmp23_ = sdx_direction;
	_tmp23__length1 = sdx_direction_length1;
	_tmp24_ = _tmp23_[SDX_DIRECTION_RIGHT];
	_tmp25_ = sdx_direction;
	_tmp25__length1 = sdx_direction_length1;
